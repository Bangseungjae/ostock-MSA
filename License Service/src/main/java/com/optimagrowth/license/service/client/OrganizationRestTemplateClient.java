...
//import com.optimagrowth.license.repository.RedisOrganizationRepository;
...
//    RedisOrganizationRepository redisOrganizationRepository;
    @Autowired
    Tracer tracer;
...
//            return redisRepository.findById(organizationId).orElse(null);
    ...
    private void cacheOrganizationObject(Organization organization) {
        try {
//            redisOrganizationRepository.save(organization);
        }catch (Exception ex){
